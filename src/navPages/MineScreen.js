...
import { Text, View,StyleSheet,Image,TouchableHighlight, Button } from 'react-native';
...
// class SayingCard extends Component {
//   render(){
// function SayingCard({navigation}){
//     return (
...
//             <Text style={{fontSize: 18, justifyContent:'flex-start',color:'#777'}}>日签内容日签内容日签内容日签内容日签内容</Text>
//             </View>
...
//       component={SayingCard} options={{headerShown:false}}/>
